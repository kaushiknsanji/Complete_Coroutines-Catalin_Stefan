...
/**
 * Code to illustrate the use of Thread confinement technique by Fine grained approach to solve the concurrent
...
fun main() {
    ...
    runBlocking {
        ...
        withContext(Dispatchers.Default) {
            massiveRun {
                // Do some computation process in parallel here..

                // After computation, update the Shared state counter in its own single threaded context
